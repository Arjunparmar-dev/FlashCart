...
fun OtpScreen(
    ...
    OtpTextBox(otp = otp,flashViewModel)
    ...
    auth.signInWithCredential(credential)
        .addOnCompleteListener(context as Activity) { task ->
            if (task.isSuccessful) {
                ...
                Toast.makeText(context,"Verification Successfully" ,Toast.LENGTH_SHORT).show()
                ...
                if (task.exception is FirebaseAuthInvalidCredentialsException) {
                    ...
                    Toast.makeText(context,"The OTP you have entered is invalid" ,Toast.LENGTH_SHORT).show()
                }
                // Update UI
            }
        }
